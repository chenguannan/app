package com.sl_group.jinyuntong_oem.myshop.gather_bill.persenter;
...
import com.sl_group.jinyuntong_oem.myshop.gather_bill.model.GatherBillModel;
import com.sl_group.jinyuntong_oem.myshop.gather_bill.model.GatherBillModelImpl;
import com.sl_group.jinyuntong_oem.myshop.gather_bill.view.GatherBillView;
...
public class GatherBillPersenter {
    ...
    public void getGatherBill(boolean isShowPeogress,int curPage, String pageSize, String beginDate, String endDate){
        mGatherBillModel.getGatherBill(isShowPeogress,curPage, pageSize, beginDate, endDate, new GatherBillModel.IGatherBillCallBack() {
            @Override
            public void onSuccess(String data) {
                ...
                if ("000000".equals(gatherBillBean.getCode())){
                    mGatherBillView.getGatherBillList(gatherBillBean.getData().getResultList());
                    return;
