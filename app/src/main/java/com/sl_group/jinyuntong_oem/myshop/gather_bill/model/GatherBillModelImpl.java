...
public class GatherBillModelImpl implements GatherBillModel {
    ...
    @Override
    public void getGatherBill(boolean isShowPeogress, int curPage, String pageSize, String beginDate, String endDate, final IGatherBillCallBack gatherBillCallBack) {
