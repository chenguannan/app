...
public class BankCardTextWatcherUtils implements TextWatcher {
    ...
    public static void bind(EditText editText) {
        new BankCardTextWatcherUtils(editText, DEFAULT_MAX_LENGTH);
    }

    public static void bind(EditText editText, int maxLength) {
        new BankCardTextWatcherUtils(editText, maxLength);
    }

    public BankCardTextWatcherUtils(EditText editText, int maxLength) {
