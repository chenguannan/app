package com.sl_group.jinyuntong_oem.gather_bill_details;
...
import com.sl_group.jinyuntong_oem.utils.MD5Utils;
...
public class GatherBillDetailsActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        if (bundle!=null){
            ...
            String settleCard = bundle.getString("settleCard","");
            if (!StringUtils.isEmpty(settleCard)){
                mTvGatherBillDetailsSettlecard.setText(StringUtils.getStarString(settleCard,6,settleCard.length()-4));
            }
