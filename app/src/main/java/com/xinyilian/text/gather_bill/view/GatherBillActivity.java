...
import com.xinyilian.text.adapter.GatherBillAdapter;
import com.xinyilian.text.base.BaseActivity;
import com.xinyilian.text.bean.GatherBillBean;
import com.xinyilian.text.gather_bill.persenter.GatherBillPersenter;
...
//        mTvGatherBillEndDate.setText(currentDate);
    ...
    @Override
    public void gatherBillSuccess(List<GatherBillBean.DataBean.ResultListBean> resultList) {
