...
public class StringUtils {
     ...
     * @return string
     */
    public static String getStarString(String string, int begin, int end) {

        if (begin >= string.length() || begin < 0) {
            return string;
        }
        ...
        return string.substring(0, begin) + starStr + string.substring(end, string.length());
