...
public class ScanCameraActivity extends Activity implements Callback, PreviewCallback {
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        if (this.counter == 2) {
            ...
            if (isBorders[0] != 1 || isBorders[1] != 1 || isBorders[2] != 1 || isBorders[3] != 1) {
                ...
                yuvimage.compressToJpeg(new Rect(0, 0, previewSize.width, previewSize.height), 60, baos);// 80--JPG图片的质量[0-100],100最高
                ...
                intent.putExtra("mData", rawImage);
