...
import com.xinyilian.text.new_details.NewDetailsActivity;
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_MESSAGE_RECEIVED.equals(intent.getAction())) {
                ...
                LogUtils.i("用户点击打开了通知：" + bundle.getString(JPushInterface.EXTRA_ALERT));

                //打开自定义的Activity
                Intent i = new Intent(context, NewDetailsActivity.class);
                i.putExtras(bundle);
