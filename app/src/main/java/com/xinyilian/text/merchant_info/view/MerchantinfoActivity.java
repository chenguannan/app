...
public class MerchantinfoActivity extends BaseActivity implements MerchantinfoView, UpLoadImgView, SetHeadView {
  ...
  //  private BroadcastReceiver mbroadcastRecevier;
    ...
    public int bindLayout() {
      //  mbroadcastRecevier=new MyReceiver();
    ...
    public void setHeadImgSuccess(SetHeadImgBean.DataBean data) {
        path1=data.getHeadPortraitDirectoryName();
        path2=data.getHeadPortraitFilePrefix();
        url="http://ww3.sinaimg.cn/large/610dc034jw1fasakfvqe1j20u00mhgn2.jpg";
      //  Picasso.with(this).load("http://ww3.sinaimg.cn/large/610dc034jw1fasakfvqe1j20u00mhgn2.jpg").into(mImgUserinfoHeadPortrait);
     ...
     public  class  MyReceiver extends BroadcastReceiver {
         ...
         public void onReceive(Context context, Intent intent) {
          ...
          //  Picasso.with(context).load("http://ww3.sinaimg.cn/large/610dc034jw1fasakfvqe1j20u00mhgn2.jpg").into(mImgUserinfoHeadPortrait);
             Picasso.with(context).load(CommonSet.PIC_START + path1 + CommonSet.PIC_END + path2).into(mImgUserinfoHeadPortrait);
         }
